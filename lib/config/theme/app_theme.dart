...
import 'package:nessa/config/theme/app_colors.dart';
import 'package:nessa/config/theme/app_text_theme.dart';
...
ThemeData get appTheme {
  final appTextTheme = AppTextTheme.textTheme.copyWith(
    ...
    headlineLarge:
        AppTextTheme.textTheme.headlineLarge?.merge(AppTextTheme.plainPoppins),
    headlineMedium:
        AppTextTheme.textTheme.headlineMedium?.merge(AppTextTheme.h4),
    ...
    titleMedium:
        AppTextTheme.textTheme.titleMedium?.merge(AppTextTheme.headline),
    titleSmall:
        AppTextTheme.textTheme.titleSmall?.merge(AppTextTheme.subHeadline),
    bodyLarge: AppTextTheme.textTheme.bodyLarge?.merge(AppTextTheme.bodyLarge),
    bodyMedium:
        AppTextTheme.textTheme.bodyMedium?.merge(AppTextTheme.bodyMedium),
    bodySmall: AppTextTheme.textTheme.bodySmall?.merge(AppTextTheme.bodySmall),
    labelLarge:
        AppTextTheme.textTheme.labelLarge?.merge(AppTextTheme.buttonLarge),
    labelMedium:
        AppTextTheme.textTheme.labelMedium?.merge(AppTextTheme.plainPoppins),
  ...
  return ThemeData.light(useMaterial3: true).copyWith(
      ...
      style: ButtonStyle(
        ...
        side: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.disabled)) {
            return BorderSide(
              width: 1.0,
              color: AppColors.lightActionState.disabledBackground
                  .withOpacity(0.24),
            );
          }
          return BorderSide(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle:
          appTextTheme.caption.copyWith(color: AppColors.lightText.disabled),
    ...
    menuTheme: MenuThemeData(
      style: MenuStyle(
        backgroundColor:
            WidgetStatePropertyAll(AppColors.lightBackground.paper),
        surfaceTintColor:
            WidgetStatePropertyAll(AppColors.lightBackground.paper),
      ),
    ),
